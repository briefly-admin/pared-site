...
export const metadata = {
  title: 'Privacy Policy | PARED',
  description: 'How PARED collects, uses, and protects your personal information, including email data and cookie tracking.',
}
    ...
    <>
      ...
      <div className="legal-page">
        ...
        <div className="legal-body">
          ...
          <p>PARED uses cookies and similar tracking technologies for the following purposes:</p>
          <ul>
            ...
            <li><strong>Affiliate tracking cookies</strong> — when you click a product link, the retailer may place a cookie to attribute any purchase to PARED for commission purposes. This is standard affiliate marketing practice and does not store personally identifying information about you.</li>
          ...
          <p>If you subscribe to PARED's newsletter, your email is stored securely with our email service provider (Buttondown, ConvertKit, or Beehiiv, depending on our current platform). You can unsubscribe at any time by clicking the unsubscribe link in any email we send. We will process your unsubscribe request promptly.</p>
          <p>We do not send spam. We will only email you content directly related to PARED's mission: quality, non-toxic product curation.</p>

          <h2>4. Third-Party Links & Affiliate Disclosure</h2>
          <p>PARED contains links to third-party retailer websites. When you click those links and make a purchase, we may receive a commission. We are not responsible for the privacy practices of those third-party sites. Please review the privacy policy of any site you visit through our links.</p>
          ...
          <p>To exercise these rights, email us at <a href="mailto:hello@pared.shop">hello@pared.shop</a>.</p>

          <h2>7. Children's Privacy</h2>
          <p>PARED is not directed at children under 13. We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, please contact us and we will delete it promptly.</p>
          ...
          <h2>9. Contact</h2>
          <p>Questions about this privacy policy? Email us at <a href="mailto:hello@pared.shop">hello@pared.shop</a>.</p>
        </div>
      </div>
      <Footer />
    </>
